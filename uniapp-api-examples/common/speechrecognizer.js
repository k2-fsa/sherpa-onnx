          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 7:
                ...
                params['reinforce_hotword'] = this.query.reinforce_hotword;
                params['engine_model_type'] = this.query.engine_model_type || '16k_zh';
                params['timestamp'] = this.query.timestamp || parseInt(serverTime) || Math.round(time / 1000);
                params['expired'] = this.query.expired || Math.round(time / 1000) + 24 * 60 * 60;
                params['nonce'] = this.query.nonce || Math.round(time / 100000);
                params['voice_id'] = this.query.voice_id || guid(); // 非必填参数
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 6:
                ...
                return _context4.abrupt("return", "".concat(signStr, "&signature=").concat(encodeURIComponent(this.sign)));
