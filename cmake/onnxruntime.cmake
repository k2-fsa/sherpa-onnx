...
function(download_onnxruntime)
  ...
  elseif(CMAKE_SYSTEM_NAME STREQUAL Android)
    if(CMAKE_SYSTEM_PROCESSOR STREQUAL aarch64)
      if(BUILD_SHARED_LIBS)
        include(onnxruntime-android-aarch64)
      else()
        include(onnxruntime-android-aarch64-static)
      endif()
    elseif(CMAKE_SYSTEM_PROCESSOR STREQUAL x86_64)
      if(BUILD_SHARED_LIBS)
        include(onnxruntime-android-x86_64)
      else()
        include(onnxruntime-android-x86_64-static)
      endif()
    elseif(CMAKE_SYSTEM_PROCESSOR STREQUAL armv7-a OR CMAKE_SYSTEM_PROCESSOR STREQUAL armv8l)
      if(BUILD_SHARED_LIBS)
        include(onnxruntime-android-arm)
      else()
        include(onnxruntime-android-arm-static)
      endif()
    elseif(CMAKE_SYSTEM_PROCESSOR STREQUAL i686)
      if(BUILD_SHARED_LIBS)
        include(onnxruntime-android-i686)
      else()
        include(onnxruntime-android-i686-static)
      endif()
    else()
      message(FATAL_ERROR "Unsupported Android processor: ${CMAKE_SYSTEM_PROCESSOR}. Only aarch64, x86_64, armv7-a, and i686 are supported at present.")
    endif()
  else()
    message(STATUS "CMAKE_SYSTEM_NAME: ${CMAKE_SYSTEM_NAME}")
    message(STATUS "CMAKE_SYSTEM_PROCESSOR: ${CMAKE_SYSTEM_PROCESSOR}")
    message(FATAL_ERROR "Only support Linux, macOS, Windows, and Android at present. Will support other OSes later")
  endif()
