function(download_portaudio)
  ...
  if(BUILD_SHARED_LIBS)
    ...
    if(SHERPA_ONNX_ENABLE_PYTHON AND WIN32)
      install(FILES portaudio DESTINATION ..)
    else()
      install(FILES portaudio DESTINATION lib)
    endif()

  else()
    set_target_properties(portaudio_static PROPERTIES OUTPUT_NAME "sherpa-onnx-portaudio_static")
    if(SHERPA_ONNX_ENABLE_PYTHON AND WIN32)
      install(FILES portaudio_static DESTINATION ..)
    else()
      install(FILES portaudio_static DESTINATION lib)
    endif()
  endif()
endfunction()
