...
if [[ -n $BUILD_SHARED_LIBS && -z $SHERPA_ONNX_BUILD_SINGLE_SHARED_LIB ]]; then
  SHERPA_ONNX_BUILD_SINGLE_SHARED_LIB=$BUILD_SHARED_LIBS
fi
...
cmake \
  ...
  -DSHERPA_ONNX_BUILD_SINGLE_SHARED_LIB=$SHERPA_ONNX_BUILD_SINGLE_SHARED_LIB \
