...
class Config:
    ...
    # "quay.io/ascend/cann:7.0.1.beta1-910b-ubuntu22.04-py3.8"
    # "gpustack/ascendai-cann:8.0.RC3-910b-ubuntu20.04-py3.9"
    # "gpustack/devel-ascendai-cann:8.2.rc1-910b-ubuntu20.04-v2"
    # "quay.io/ascend/cann:7.0.1-310p-ubuntu22.04-py3.9"
    image: str = ""
...
def main():
    ...
    cann_version = ["7.0", "8.0"]
    soc_version = ["910B", "910B2"]
    input_in_seconds = ["5", "8"]
