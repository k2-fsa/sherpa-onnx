...
|----|--------------|-----------------|
| Linux | x86_64 | `sherpa-onnx-v1.13.6-linux-x64-static-lib.tar.bz2` |
| Linux | aarch64 | `sherpa-onnx-v1.13.6-linux-aarch64-static-lib.tar.bz2` |
...
| OS | Architecture | Archive example |
|----|--------------|-----------------|
| Linux | x86_64 | `sherpa-onnx-v1.13.6-linux-x64-shared-lib.tar.bz2` |
| Linux | aarch64 | `sherpa-onnx-v1.13.6-linux-aarch64-shared-cpu-lib.tar.bz2` |
