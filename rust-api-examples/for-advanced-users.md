...
- manually extracted release archive:
  `/path/to/sherpa-onnx-v1.13.1-linux-x64-static-lib/lib`
...
| Windows | x86_64 | `sherpa-onnx-v1.13.1-win-x64-static-MT-Release-lib.tar.bz2` |
...
| Windows | x86_64 | `sherpa-onnx-v1.13.1-win-x64-shared-MT-Release-lib.tar.bz2` |
