...
- manually extracted release archive:
  `/path/to/sherpa-onnx-v1.12.40-linux-x64-static-lib/lib`
...
|----|--------------|-----------------|
| Linux | x86_64 | `sherpa-onnx-v1.12.40-linux-x64-static-lib.tar.bz2` |
| Linux | aarch64 | `sherpa-onnx-v1.12.40-linux-aarch64-static-lib.tar.bz2` |
| macOS | x86_64 | `sherpa-onnx-v1.12.40-osx-x64-static-lib.tar.bz2` |
| macOS | arm64 | `sherpa-onnx-v1.12.40-osx-arm64-static-lib.tar.bz2` |
| Windows | x86_64 | `sherpa-onnx-v1.12.40-win-x64-static-MT-Release-lib.tar.bz2` |
...
| OS | Architecture | Archive example |
|----|--------------|-----------------|
| Linux | x86_64 | `sherpa-onnx-v1.12.40-linux-x64-shared-lib.tar.bz2` |
| Linux | aarch64 | `sherpa-onnx-v1.12.40-linux-aarch64-shared-cpu-lib.tar.bz2` |
| macOS | x86_64 | `sherpa-onnx-v1.12.40-osx-x64-shared-lib.tar.bz2` |
| macOS | arm64 | `sherpa-onnx-v1.12.40-osx-arm64-shared-lib.tar.bz2` |
| Windows | x86_64 | `sherpa-onnx-v1.12.40-win-x64-shared-MT-Release-lib.tar.bz2` |
