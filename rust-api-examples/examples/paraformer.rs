...
fn main() {
    ...
    recognizer_config.model_config.paraformer = OfflineParaformerModelConfig {
    ...
    if let Some(result) = stream.get_result() {
        ...
        println!("Recognition time     : {:.3} seconds", recognition_elapsed);
