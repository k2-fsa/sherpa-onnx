...
int32_t main() {
  ...
  punctuation_config.model.cnn_bilstm = "sherpa-onnx-online-punct-en-2024-08-06/model.int8.onnx";
  punctuation_config.model.bpe_vocab = "sherpa-onnx-online-punct-en-2024-08-06/bpe.vocab";
