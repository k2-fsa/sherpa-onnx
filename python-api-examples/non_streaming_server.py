...
cd /path/to/sherpa-onnx
curl -SL -O https://github.com/k2-fsa/sherpa-onnx/releases/download/asr-models/sherpa-onnx-paraformer-zh-2023-04-19.tar.bz2
tar xvf sherpa-onnx-paraformer-zh-2023-04-19.tar.bz2
rm sherpa-onnx-paraformer-zh-2023-04-19.tar.bz2

python3 ./python-api-examples/non_streaming_server.py \
  --paraformer ./sherpa-onnx-paraformer-zh-2023-04-19/model.int8.onnx \
  --tokens ./sherpa-onnx-paraformer-zh-2023-04-19/tokens.txt
