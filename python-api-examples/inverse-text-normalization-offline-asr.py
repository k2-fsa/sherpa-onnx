...
wget https://github.com/k2-fsa/sherpa-onnx/releases/download/asr-models/sherpa-onnx-paraformer-zh-2023-04-19.tar.bz2
...
def create_recognizer():
    model = "./sherpa-onnx-paraformer-zh-2023-04-19/model.int8.onnx"
