...
Future<sherpa_onnx.OnlinePunctuationConfig> prepareModelConfig() async {
  return punctConfig;
}
...
/// Convert OnlinePunctuationConfig to JS config for the worker.
JSObject configToJs(sherpa_onnx.OnlinePunctuationConfig cfg) {
