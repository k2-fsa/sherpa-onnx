...
void InitVersion(Napi::Env env, Napi::Object exports) {
  ...
  Napi::String onnxruntime_version =
      Napi::String::New(env, SherpaOnnxGetOnnxruntimeVersionStr());
  ...
  exports.Set(Napi::String::New(env, "onnxruntimeVersion"), onnxruntime_version);
}
