...
#
# This script is to build sherpa-onnx for WebAssembly (Web browser)
...
mkdir -p build-wasm-simd-web
pushd build-wasm-simd-web
...
cmake \
  ...
  -DSHERPA_ONNX_ENABLE_WASM_WEB=ON \
