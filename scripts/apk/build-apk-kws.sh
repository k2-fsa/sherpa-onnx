...
for arch in arm64-v8a armeabi-v7a x86_64 x86; do
  ...
  ./gradlew assembleDebug -Pandroid.injected.build.abi=$arch
  popd

  mv android/SherpaOnnxKws/app/build/intermediates/apk/debug/app-debug.apk ./apks/sherpa-onnx-${SHERPA_ONNX_VERSION}-$arch-kws-zh-wenetspeech-zipformer.apk
...
for arch in arm64-v8a armeabi-v7a x86_64 x86; do
  ...
  mv android/SherpaOnnxKws/app/build/intermediates/apk/debug/app-debug.apk ./apks/sherpa-onnx-${SHERPA_ONNX_VERSION}-$arch-kws-en-gigaspeech-zipformer.apk
  ls -lh apks
  rm -v ./android/SherpaOnnxKws/app/src/main/jniLibs/$arch/*.so
done
