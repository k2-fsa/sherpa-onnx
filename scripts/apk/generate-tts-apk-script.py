...
class TtsModel:
    ...
    cmd: str = "" # cmd is used to remove extra file from the model directory
...
def get_zipvoice_models() -> List[TtsModel]:
    multi_lingual_models = [
        TtsModel(
            ...
            rm -fv text_encoder_int8.onnx fm_decoder_int8.onnx
        ...
        TtsModel(
            ...
            rm -fv text_encoder.onnx fm_decoder.onnx
