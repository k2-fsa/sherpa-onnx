...
for arch in arm64-v8a armeabi-v7a x86_64 x86; do
  ...
  mv android/SherpaOnnxVad/app/build/intermediates/apk/debug/app-debug.apk ./apks/sherpa-onnx-${SHERPA_ONNX_VERSION}-$arch-silero_vad.apk
  ls -lh apks
...
for arch in arm64-v8a armeabi-v7a x86_64 x86; do
  ...
  mv android/SherpaOnnxVad/app/build/intermediates/apk/debug/app-debug.apk ./apks/sherpa-onnx-${SHERPA_ONNX_VERSION}-$arch-ten_vad.apk
  ls -lh apks
  rm -v ./android/SherpaOnnxVad/app/src/main/jniLibs/$arch/*.so
done
