...
cp -v /sherpa-onnx/scripts/zipformer-transducer/x-asr/test_onnx_non_streaming.py punct/test_onnx.py
cp -v /sherpa-onnx/scripts/zipformer-transducer/x-asr/test_onnx_non_streaming.py no-punct/test_onnx.py
