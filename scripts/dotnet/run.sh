...
if [ ! -f $src_dir/linux-x64/libsherpa-onnx-c-api.so ]; then
  ...
  if [ -f $linux_x64_wheel ]; then
    ...
    curl -OL https://$HF_MIRROR/csukuangfj/sherpa-onnx-wheels/resolve/main/$SHERPA_ONNX_VERSION/$linux_x64_wheel_filename
  fi
...
if [ ! -f $src_dir/linux-arm64/libsherpa-onnx-c-api.so ]; then
  ...
  if [ -f $linux_arm64_wheel ]; then
    ...
    curl -OL https://$HF_MIRROR/csukuangfj/sherpa-onnx-wheels/resolve/main/$SHERPA_ONNX_VERSION/$linux_arm64_wheel_filename
  fi
...
if [ ! -f $src_dir/macos-x64/libsherpa-onnx-c-api.dylib ]; then
  ...
  if [ -f $macos_x64_wheel  ]; then
    ...
    curl -OL https://$HF_MIRROR/csukuangfj/sherpa-onnx-wheels/resolve/main/$SHERPA_ONNX_VERSION/$macos_x64_wheel_filename
  fi
...
if [ ! -f $src_dir/macos-arm64/libsherpa-onnx-c-api.dylib ]; then
  ...
  if [ -f $macos_arm64_wheel  ]; then
    ...
    curl -OL https://$HF_MIRROR/csukuangfj/sherpa-onnx-wheels/resolve/main/$SHERPA_ONNX_VERSION/$macos_arm64_wheel_filename
  fi
...
if [ ! -f $src_dir/windows-x64/sherpa-onnx-c-api.dll ]; then
  ...
  if [ -f $windows_x64_wheel ]; then
    ...
    curl -OL https://$HF_MIRROR/csukuangfj/sherpa-onnx-wheels/resolve/main/$SHERPA_ONNX_VERSION/$windows_x64_wheel_filename
  fi
