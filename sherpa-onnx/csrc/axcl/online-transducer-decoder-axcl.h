...
#ifndef SHERPA_ONNX_CSRC_AXCL_ONLINE_TRANSDUCER_DECODER_AXCL_H_
#define SHERPA_ONNX_CSRC_AXCL_ONLINE_TRANSDUCER_DECODER_AXCL_H_
...
struct OnlineTransducerDecoderResultAxcl {
...
class OnlineTransducerDecoderAxcl {
 public:
  virtual ~OnlineTransducerDecoderAxcl() = default;
   ...
   */
  virtual OnlineTransducerDecoderResultAxcl GetEmptyResult() const = 0;
  ...
  virtual void Decode(std::vector<float> encoder_out,
                      OnlineTransducerDecoderResultAxcl *result) const = 0;
};

}  // namespace sherpa_onnx

#endif  // SHERPA_ONNX_CSRC_AXCL_ONLINE_TRANSDUCER_DECODER_AXCL_H_
