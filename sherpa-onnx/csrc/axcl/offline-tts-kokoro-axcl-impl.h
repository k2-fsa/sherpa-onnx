...
#ifndef SHERPA_ONNX_CSRC_AXCL_OFFLINE_TTS_KOKORO_AXCL_IMPL_H_
#define SHERPA_ONNX_CSRC_AXCL_OFFLINE_TTS_KOKORO_AXCL_IMPL_H_
...
class OfflineTtsKokoroAxclImpl : public OfflineTtsImpl {
 public:
  explicit OfflineTtsKokoroAxclImpl(const OfflineTtsConfig &config)
  ...
  OfflineTtsKokoroAxclImpl(Manager *mgr, const OfflineTtsConfig &config)
      : config_(config),
...
#endif  // SHERPA_ONNX_CSRC_AXCL_OFFLINE_TTS_KOKORO_AXCL_IMPL_H_
