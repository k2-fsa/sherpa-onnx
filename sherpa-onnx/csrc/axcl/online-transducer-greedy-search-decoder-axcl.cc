...
OnlineTransducerGreedySearchDecoderAxcl::GetEmptyResult() const {
...
void OnlineTransducerGreedySearchDecoderAxcl::StripLeadingBlanks(
...
void OnlineTransducerGreedySearchDecoderAxcl::Decode(
