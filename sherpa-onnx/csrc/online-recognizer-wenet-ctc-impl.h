...
static OnlineRecognizerResult Convert2(const OnlineParaformerDecoderResult &src,
...
// TODO(fangjun): Add a ctc model and a online recognizer for ctc models
// The current implementation is to specific and is exclusive for wenet ctc
// models.
class OnlineRecognizerWenetCtcImpl : public OnlineRecognizerImpl {
 public:
  ...
  OnlineRecognizerResult GetResult(OnlineStream *s) const override {
    ...
    return Convert2(decoder_result, sym_);
  }
