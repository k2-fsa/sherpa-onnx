...
OnlineTransducerModifiedBeamSearchDecoderAxera::GetEmptyResult() const {
...
void OnlineTransducerModifiedBeamSearchDecoderAxera::StripLeadingBlanks(
...
std::vector<std::vector<float>> GetJoinerOutLogSoftmax(
    OnlineZipformerTransducerModelAxera *model, const float *p_encoder_out,
...
void OnlineTransducerModifiedBeamSearchDecoderAxera::Decode(
