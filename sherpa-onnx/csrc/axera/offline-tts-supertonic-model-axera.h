...
#ifndef SHERPA_ONNX_CSRC_AXERA_OFFLINE_TTS_SUPERTONIC_MODEL_AXERA_H_
#define SHERPA_ONNX_CSRC_AXERA_OFFLINE_TTS_SUPERTONIC_MODEL_AXERA_H_
...
class OfflineTtsSupertonicModelAxera {
 public:
  ~OfflineTtsSupertonicModelAxera();

  explicit OfflineTtsSupertonicModelAxera(
      const OfflineTtsModelConfig &config);

  template <typename Manager>
  OfflineTtsSupertonicModelAxera(Manager *mgr,
                                 const OfflineTtsModelConfig &config);
...
#endif  // SHERPA_ONNX_CSRC_AXERA_OFFLINE_TTS_SUPERTONIC_MODEL_AXERA_H_
