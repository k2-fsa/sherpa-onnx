// sherpa-onnx/csrc/axera/online-transducer-decoder-axera.h
//
// Copyright (c)  2025  Xiaomi Corporation

#ifndef SHERPA_ONNX_CSRC_AXERA_ONLINE_TRANSDUCER_DECODER_AXERA_H_
#define SHERPA_ONNX_CSRC_AXERA_ONLINE_TRANSDUCER_DECODER_AXERA_H_
...
struct OnlineTransducerDecoderResultAxera {
...
class OnlineTransducerDecoderAxera {
 public:
  virtual ~OnlineTransducerDecoderAxera() = default;
   ...
   */
  virtual OnlineTransducerDecoderResultAxera GetEmptyResult() const = 0;
  ...
  virtual void Decode(std::vector<float> encoder_out,
                      OnlineTransducerDecoderResultAxera *result) const = 0;
};

}  // namespace sherpa_onnx

#endif  // SHERPA_ONNX_CSRC_AXERA_ONLINE_TRANSDUCER_DECODER_AXERA_H_
