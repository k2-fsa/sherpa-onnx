...
//! `DYLD_LIBRARY_PATH`.
//!
//! Example `v1.13.6` archives used by the build script:
//!
//! Default static archives:
//!
//! - Linux x86_64:
//!   [sherpa-onnx-v1.13.6-linux-x64-static-lib.tar.bz2](https://github.com/k2-fsa/sherpa-onnx/releases/download/v1.13.6/sherpa-onnx-v1.13.6-linux-x64-static-lib.tar.bz2)
//! - Linux aarch64:
//!   [sherpa-onnx-v1.13.6-linux-aarch64-static-lib.tar.bz2](https://github.com/k2-fsa/sherpa-onnx/releases/download/v1.13.6/sherpa-onnx-v1.13.6-linux-aarch64-static-lib.tar.bz2)
//! - macOS x86_64:
//!   [sherpa-onnx-v1.13.6-osx-x64-static-lib.tar.bz2](https://github.com/k2-fsa/sherpa-onnx/releases/download/v1.13.6/sherpa-onnx-v1.13.6-osx-x64-static-lib.tar.bz2)
//! - macOS arm64:
...
//! - iOS arm64:
//!   [sherpa-onnx-v1.13.6-ios-static.xcframework.zip](https://github.com/k2-fsa/sherpa-onnx/releases/download/xcframework/sherpa-onnx-v1.13.6-ios-static.xcframework.zip)
//!
//! Optional shared archives:
//!
//! - Linux x86_64:
//!   [sherpa-onnx-v1.13.6-linux-x64-shared-lib.tar.bz2](https://github.com/k2-fsa/sherpa-onnx/releases/download/v1.13.6/sherpa-onnx-v1.13.6-linux-x64-shared-lib.tar.bz2)
//! - Linux aarch64:
//!   [sherpa-onnx-v1.13.6-linux-aarch64-shared-cpu-lib.tar.bz2](https://github.com/k2-fsa/sherpa-onnx/releases/download/v1.13.6/sherpa-onnx-v1.13.6-linux-aarch64-shared-cpu-lib.tar.bz2)
//! - macOS x86_64:
//!   [sherpa-onnx-v1.13.6-osx-x64-shared-lib.tar.bz2](https://github.com/k2-fsa/sherpa-onnx/releases/download/v1.13.6/sherpa-onnx-v1.13.6-osx-x64-shared-lib.tar.bz2)
//! - macOS arm64:
...
//! - iOS arm64 (shared, onnxruntime statically linked):
