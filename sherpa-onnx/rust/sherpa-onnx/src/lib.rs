...
//!
//! ```toml
//! sherpa-onnx = { version = "1.12.40", default-features = false, features = ["shared"] }
//! ```
//!
...
//! `DYLD_LIBRARY_PATH`.
//!
//! Example `v1.12.40` archives used by the build script:
//!
//! Default static archives:
//!
//! - Linux x86_64:
//!   [sherpa-onnx-v1.12.40-linux-x64-static-lib.tar.bz2](https://github.com/k2-fsa/sherpa-onnx/releases/download/v1.12.40/sherpa-onnx-v1.12.40-linux-x64-static-lib.tar.bz2)
//! - Linux aarch64:
//!   [sherpa-onnx-v1.12.40-linux-aarch64-static-lib.tar.bz2](https://github.com/k2-fsa/sherpa-onnx/releases/download/v1.12.40/sherpa-onnx-v1.12.40-linux-aarch64-static-lib.tar.bz2)
//! - macOS x86_64:
//!   [sherpa-onnx-v1.12.40-osx-x64-static-lib.tar.bz2](https://github.com/k2-fsa/sherpa-onnx/releases/download/v1.12.40/sherpa-onnx-v1.12.40-osx-x64-static-lib.tar.bz2)
//! - macOS arm64:
//!   [sherpa-onnx-v1.12.40-osx-arm64-static-lib.tar.bz2](https://github.com/k2-fsa/sherpa-onnx/releases/download/v1.12.40/sherpa-onnx-v1.12.40-osx-arm64-static-lib.tar.bz2)
//! - Windows x64:
//!   [sherpa-onnx-v1.12.40-win-x64-static-MT-Release-lib.tar.bz2](https://github.com/k2-fsa/sherpa-onnx/releases/download/v1.12.40/sherpa-onnx-v1.12.40-win-x64-static-MT-Release-lib.tar.bz2)
//!
//! Optional shared archives:
//!
//! - Linux x86_64:
//!   [sherpa-onnx-v1.12.40-linux-x64-shared-lib.tar.bz2](https://github.com/k2-fsa/sherpa-onnx/releases/download/v1.12.40/sherpa-onnx-v1.12.40-linux-x64-shared-lib.tar.bz2)
//! - Linux aarch64:
//!   [sherpa-onnx-v1.12.40-linux-aarch64-shared-cpu-lib.tar.bz2](https://github.com/k2-fsa/sherpa-onnx/releases/download/v1.12.40/sherpa-onnx-v1.12.40-linux-aarch64-shared-cpu-lib.tar.bz2)
//! - macOS x86_64:
//!   [sherpa-onnx-v1.12.40-osx-x64-shared-lib.tar.bz2](https://github.com/k2-fsa/sherpa-onnx/releases/download/v1.12.40/sherpa-onnx-v1.12.40-osx-x64-shared-lib.tar.bz2)
//! - macOS arm64:
//!   [sherpa-onnx-v1.12.40-osx-arm64-shared-lib.tar.bz2](https://github.com/k2-fsa/sherpa-onnx/releases/download/v1.12.40/sherpa-onnx-v1.12.40-osx-arm64-shared-lib.tar.bz2)
//! - Windows x64:
//!   [sherpa-onnx-v1.12.40-win-x64-shared-MT-Release-lib.tar.bz2](https://github.com/k2-fsa/sherpa-onnx/releases/download/v1.12.40/sherpa-onnx-v1.12.40-win-x64-shared-MT-Release-lib.tar.bz2)
//!
