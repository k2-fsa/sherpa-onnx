...
void PybindTensorrtConfig(py::module *m) {
  ...
  py::class_<PyClass>(*m, "TensorrtConfig")
      ...
      //      py::arg("trt_dump_subgraphs") = false)
        ...
        //    py::arg("trt_max_workspace_size"),
        //    py::arg("trt_max_partition_iterations"),
        //    py::arg("trt_min_subgraph_size"),
        //    py::arg("trt_fp16_enable"),
        //    py::arg("trt_detailed_build_log"),
        //    py::arg("trt_engine_cache_enable"),
        //    py::arg("trt_timing_cache_enable"),
        //    py::arg("trt_engine_cache_path"),
        //    py::arg("trt_timing_cache_path"),
        //    py::arg("trt_dump_subgraphs"))